...
print("The rules are simple... guess the number I am thinking of...")
...
def start_game():
    ...
    global highscore
    print("\nOkay {}, the high score is {}.\nLet's see what you got!\n".format(user_name, highscore))
